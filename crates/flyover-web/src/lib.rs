...
use flyover_render::mesh::{self, FeatureRaw, PreparedTile, Vertex};
use flyover_render::tileset::{decode_tile, TileKey, TileSet};
use flyover_render::{RenderParams, Scene, TileProvider, ViewOptions};
...
impl WebViewer {
    ...
    pub fn deliver(&mut self, z: u8, x: u32, y: u32, vertices: &[u8], features: &[u8]) {
...
pub fn prepare_tile(
    ...
    Ok(js_sys::Array::of2(&vertices, &features))
}
